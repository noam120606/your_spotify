    ...
    <div {...stylex.props(styles.container)}>
      <div {...stylex.props(styles.card)}>
        ...
        <Text as="p" xstyle={styles.subtitle}>
          Relive your musical journey. Connect to explore your top tracks, artists, and listening
          history with stunning visualizations.
        </Text>
        <div {...stylex.props(styles.loginButtonWrapper)} onClick={login}>
          <button {...stylex.props(styles.loginButtonInner)}>Sign In with Spotify</button>
        </div>
      </div>
