    ...
    <div {...stylex.props(styles.showcaseContent)}>
      <div {...stylex.props(styles.header)}>
        ...
        <div {...stylex.props(styles.toggleContainer)}>
          ...
          <Toggle checked={mode === "dark"} onChange={toggleDarkMode} />
        </div>
      </div>
      ...
      <div {...stylex.props(styles.section)}>
        ...
        <Text size="xxlarge" weight="bold">
          Headline 1 (xxlarge, bold)
        </Text>
        <Text size="xlarge" weight="semiBold">
          Headline 2 (xlarge, semiBold)
        </Text>
        ...
        <Text size="small" weight="regular" color="textSecondary">
          Caption text (small, regular, secondary)
        </Text>
        <br />
