...
export function Sidebar() {
  ...
  function renderNavItem(item: { path: string, label: string, group?: string, icon: React.ElementType }) {
        ...
        <nav {...stylex.props(styles.navigation)}>
          ...
          <div {...stylex.props(styles.navGroup)}>
            <div {...stylex.props(styles.groupTitle)}>
              <Text size="small" weight="bold" color="textSecondary">Tops</Text>
            </div>
          ...
          <div {...stylex.props(styles.navGroup)}>
            <div {...stylex.props(styles.groupTitle)}>
              <Text size="small" weight="bold" color="textSecondary">Settings</Text>
            </div>
